...
import { Text, type TextStyle, TouchableOpacity, View, I18nManager } from 'react-native';
...
export default function ShowHide({
  ...
  return (
    <View style={[styles.showHideButton, I18nManager.isRTL ? {flexDirection: 'row'} : {}]}>
      <TouchableOpacity onPress={() => setIsShowHide(!isShowHide)}>
        <View style={[styles.row, I18nManager.isRTL ? {flexDirection: 'row-reverse'} : {}]}>
          <PredeterminedIcon
